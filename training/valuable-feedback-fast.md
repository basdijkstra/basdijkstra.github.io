...
While that goal sounds simple enough, I have seen many teams and organizations struggle to achieve it in the two decades that I've been active in the field. I have also noticed that teams often try to address their test automation challenges by looking for better tools, more tests, or more automation.

But more automation does not automatically mean better feedback. The real challenge is _understanding what feedback you need, where and when you need it, and how to obtain it quickly and reliably_.
...
* Choosing the appropriate level for feedback
* Breaking down and improving higher-level tests where appropriate
...
You will consider what should happen to the existing tests, what principles should guide future development, and how ValuBank can continue improving its feedback system without simply accumulating more automation.

We then take a step back and use the 5W1H (Kipling) method as an alternative lens for thinking about a test automation strategy. We will use it to explore questions such as why we automate, what feedback we need, where we should obtain it, and how we should build and maintain it.
...
* Presenting and defending your recommendations

## Who should take this course?
This course is for software development and testing practitioners, as well as tech and team leads, who want to learn how to approach test automation as a way of providing valuable feedback, fast.

It is particularly suitable for people who are already familiar with automated testing and want to improve the way they design, maintain and use automation within a development process.
...
* develop and defend a test automation strategy based on the results of the experiments performed
