...
Almost every time, though, test automation problems go deeper than just the tool. <u>Often, they are of both a technical and an organizational nature</u>. Wouldn't it be wise to approach and address them like that, then, instead of throwing another tool at the problem and hoping this one will make the problem go away?
...
* Introduction to the [5W1H methodology](https://en.wikipedia.org/wiki/Five_Ws){:target="_blank"}
...
* [Breaking down E2E tests](/breaking-down-your-e2e-tests-an-example/){:target="_blank"}
...
_Day three - 'Who?', 'how?' and 'where to from here?'_
...
* The importance of [testing your tests](/testing-your-tests/)
...
The 'Valuable feedback, fast' course takes 3 days. The wide range of exercises in this course are designed to address both the technical and the organizational aspects of succeeding with test automation. As a participant, you will:
