---
title: Using AI responsibly in test automation workshop
layout: page
...
In this workshop, we will address both traps and explore how to use AI as a deliberate and effective assistant in test automation, rather than as an uncontrolled shortcut.
...
* How and where AI can effectively support test automation work, and where it should not be used
* How to define clear guardrails and constraints when working with AI-generated test code
...
Why do we need these skills in a time when AI seems to be able to write our tests for us? That's a great question.

First, accountability for testing and automation and for the information provided by these tests remains with the team, that is, with _you_. That means you will need the skills to assess whether AI-generated tests are meaningful, reliable and aligned with their quality goals.
...
This workshop uses [Claude Code](https://code.claude.com/docs/en/overview){:target="_blank"} as the primary AI assistant, and typically uses Playwright as the example test automation tool. However, the concepts and exercises are tool-agnostic, and the workshop can also be run using other tools, such as Selenium, Cypress, or REST Assured.
...
Some prior experience with test automation is required. Familiarity with Playwright, REST Assured, or a similar tool is beneficial, but not mandatory.
